...
@Component({
  selector: 'app-descision-maker-list',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './descision-maker-list.component.html',
  styleUrl: './descision-maker-list.component.scss',
})
export class DescisionMakerListComponent {
  searchText: string = '';
  itemsPerPage: number = 20;
  entriesOptions: number[] = [5, 10, 15, 25];
  p: number = 1; // Page number for pagination
  decisionmanagerList: any[] = []; // Initialize with your data
  ...
  get filteredUsers(): any[] {
    if (!this.searchText) return this.decisionmanagerList;
    return this.decisionmanagerList.filter((user) =>
